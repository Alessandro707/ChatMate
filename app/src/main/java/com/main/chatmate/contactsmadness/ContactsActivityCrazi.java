...
public class ContactsActivityCrazi extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, AdapterView.OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_contacts_crazi);
		...
		getLoaderManager().initLoader(CONTACTS_LOADER_ID,
				...
				this);
		setupCursorAdapter();
		ListView listViewContacts = (ListView) findViewById(R.id.contacts_contacts_listView2);
	...
	private void setupCursorAdapter() {
		...
		int[] uiBindTo = {R.id.contact_name, R.id.contact_img};
		// Create the simple cursor adapter to use for our list
		// specifying the template to inflate (item_contact),
		mAdapter = new ImageCursorAdapter(
				this, R.layout.contact_layout,
