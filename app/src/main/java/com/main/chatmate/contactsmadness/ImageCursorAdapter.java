...
public class ImageCursorAdapter extends SimpleCursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ImageView contactImageView = (ImageView) view.findViewById(R.id.contact_img);
        TextView contactTextView = (TextView) view.findViewById(R.id.contact_name);
        ...
        if (imageUriStr != null) {
            ...
            contactImageView.setImageResource(R.mipmap.app_icon_round);
        }
        contactTextView.setText(contactName);
        MyLogger.log("contact loaded: " + contactName);
    }
